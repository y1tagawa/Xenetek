...
class X11Colors {
  ...
  static const colors = <Color>[
    X11Colors.mediumVioletRed,
    X11Colors.deepPink,
    X11Colors.paleVioletRed,
    X11Colors.hotPink,
    X11Colors.lightPink,
    X11Colors.pink,
    X11Colors.darkRed,
    ...
    X11Colors.crimson,
    X11Colors.indianRed,
    X11Colors.lightCoral,
    X11Colors.salmon,
    X11Colors.darkSalmon,
    X11Colors.lightSalmon,
    X11Colors.orangeRed,
    X11Colors.tomato,
    X11Colors.darkOrange,
    X11Colors.coral,
    X11Colors.orange,
    X11Colors.darkKhaki,
    X11Colors.gold,
    ...
    X11Colors.peachPuff,
    X11Colors.yellow,
    X11Colors.paleGoldenrod,
    X11Colors.moccasin,
    X11Colors.papayaWhip,
    X11Colors.lightGoldenrodYellow,
    X11Colors.lemonChiffon,
    X11Colors.lightYellow,
    X11Colors.maroon,
    X11Colors.brown,
    X11Colors.saddleBrown,
    X11Colors.sienna,
    X11Colors.chocolate,
    X11Colors.darkGoldenrod,
    X11Colors.peru,
    X11Colors.rosyBrown,
    X11Colors.goldenrod,
    X11Colors.sandyBrown,
    X11Colors.tan,
    X11Colors.burlywood,
    X11Colors.wheat,
    X11Colors.navajoWhite,
    X11Colors.bisque,
    X11Colors.blanchedAlmond,
    X11Colors.cornsilk,
    X11Colors.indigo,
    X11Colors.rebeccaPurple,
    X11Colors.purple,
    X11Colors.darkMagenta,
    X11Colors.darkViolet,
    X11Colors.darkSlateBlue,
    X11Colors.blueViolet,
    X11Colors.darkOrchid,
    X11Colors.fuchsia,
    X11Colors.magenta,
    X11Colors.slateBlue,
    X11Colors.mediumSlateBlue,
    X11Colors.mediumOrchid,
    X11Colors.mediumPurple,
    X11Colors.orchid,
    X11Colors.violet,
    X11Colors.plum,
    X11Colors.thistle,
    ...
    X11Colors.darkGreen,
    X11Colors.green,
    X11Colors.darkOliveGreen,
    X11Colors.forestGreen,
    X11Colors.seaGreen,
    X11Colors.olive,
    X11Colors.oliveDrab,
    X11Colors.mediumSeaGreen,
    X11Colors.limeGreen,
    X11Colors.lime,
    X11Colors.springGreen,
    X11Colors.mediumSpringGreen,
    X11Colors.darkSeaGreen,
    X11Colors.mediumAquamarine,
    X11Colors.yellowGreen,
    X11Colors.lawnGreen,
    X11Colors.chartreuse,
    X11Colors.lightGreen,
    X11Colors.greenYellow,
    X11Colors.paleGreen,
    X11Colors.teal,
    X11Colors.darkCyan,
    X11Colors.lightSeaGreen,
    X11Colors.cadetBlue,
    X11Colors.darkTurquoise,
    X11Colors.mediumTurquoise,
    X11Colors.turquoise,
    X11Colors.aqua,
    X11Colors.cyan,
    X11Colors.aquamarine,
    X11Colors.paleTurquoise,
    X11Colors.lightCyan,
    X11Colors.midnightBlue,
    X11Colors.navy,
    X11Colors.darkBlue,
    X11Colors.mediumBlue,
    X11Colors.blue,
    X11Colors.royalBlue,
    X11Colors.steelBlue,
    X11Colors.dodgerBlue,
    X11Colors.deepSkyBlue,
    X11Colors.cornflowerBlue,
    X11Colors.skyBlue,
    X11Colors.lightSkyBlue,
    X11Colors.lightSteelBlue,
    X11Colors.lightBlue,
    X11Colors.powderBlue,
    X11Colors.mistyRose,
    X11Colors.antiqueWhite,
    X11Colors.linen,
    X11Colors.beige,
    X11Colors.whiteSmoke,
    X11Colors.lavenderBlush,
    X11Colors.oldLace,
    X11Colors.aliceBlue,
    X11Colors.seashell,
    X11Colors.ghostWhite,
    X11Colors.honeydew,
    X11Colors.floralWhite,
    X11Colors.azure,
    X11Colors.mintCream,
    X11Colors.snow,
    X11Colors.ivory,
    X11Colors.white,
    X11Colors.black,
    X11Colors.darkSlateGray,
    X11Colors.dimGray,
    X11Colors.slateGray,
    X11Colors.gray,
    X11Colors.lightSlateGray,
    X11Colors.darkGray,
    X11Colors.silver,
    X11Colors.lightGray,
    X11Colors.gainsboro,
...
const x11Colors = X11Colors.colors;
